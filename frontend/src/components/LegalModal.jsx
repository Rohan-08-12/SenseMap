...
const PRIVACY_CONTENT = {
    ...
    sections: [
        ...
        {
            heading: 'Contact',
            body: 'For privacy questions contact: rohannayyer12@gmail.com',
        },
    ],
};
...
const TERMS_CONTENT = {
    ...
    sections: [
        ...
        {
            heading: 'Changes',
            body: 'We may update these terms as the platform evolves. Continued use after updates constitutes acceptance. For questions contact: rohannayyer12@gmail.com',
        },
    ],
};
